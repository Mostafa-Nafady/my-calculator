 ...
 */
function createHeader(title, navLinks = [{ label: 'RTEA', href: '/rtea' }, { label: 'ASSDSFSF', href: '/assdsfsf' }, { label: 'AWXZ', href: '/awxz' }, { label: 'QWEQ', href: '/qweq' }]) {
 ...
 * @param {Array<{label: string, href: string}>} [navLinks] - Optional navigation links
 */
function renderHeader(containerId, title, navLinks = [{ label: 'RTEA', href: '/rtea' }, { label: 'ASSDSFSF', href: '/assdsfsf' }, { label: 'AWXZ', href: '/awxz' }, { label: 'QWEQ', href: '/qweq' }]) {
 ...
 * @param {Array<{label: string, href: string}>} [navLinks] - Optional navigation links
 */
function replaceHeader(title, navLinks = [{ label: 'RTEA', href: '/rtea' }, { label: 'ASSDSFSF', href: '/assdsfsf' }, { label: 'AWXZ', href: '/awxz' }, { label: 'QWEQ', href: '/qweq' }]) {
